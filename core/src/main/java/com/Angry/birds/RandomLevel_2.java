...
public class RandomLevel_2 implements Screen {
    ...
    private Texture pigTexture1, pigTexture2;
    ...
    public RandomLevel_2(Game game) {
        this.game = game;
    ...
    public void show() {
        ...
        blockTexture1 = new Texture(Gdx.files.internal("Wood1.png"));



        blocks = new ArrayList<>();
        blocks.add(new Block(blockTexture1, world, 540, 70, 70, 70, 0.5f,2));


        pigs = new ArrayList<>();
        pigs.add(new Pig(pigTexture1, world, 480, 70,2));
        pigs.add(new Pig(pigTexture2, world, 550, 170, 2));
        ...
        pauseButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new PauseScreen(game, RandomLevel_2.this));
            }
        });
