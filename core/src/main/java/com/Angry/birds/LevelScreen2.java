...
public class LevelScreen2 implements Screen {
    ...
    private Stage stage;  // Add Stage for UI
    private Skin skin;
    private Game game;
    ...
    public void show() {
        ...
        pigTexture5 = new Texture(Gdx.files.internal("guard_pig.png"));
        ...
        pauseButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new PauseScreen(game, LevelScreen2.this));
            }
        });
        ...
        bird = new Bird(new Texture(Gdx.files.internal("Chuck.png")), world);
